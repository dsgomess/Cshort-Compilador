...
enum OP_ARIT_COD {
    ATRIBUICAO = 200, ADICAO, SUBTRACAO, MULTIPLICACAO, DIVISAO
};

enum OP_RELAC_COD {
    IGUALDADE = 300, DIFERENTE, MENOR_IGUAL, MAIOR_IGUAL,
    MENOR_QUE, MAIOR_QUE
};

enum OP_LOGIC_COD {
    AND_LOGIC = 400, OR_LOGIC, NOT_LOGIC
};
